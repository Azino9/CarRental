  ...
  return (
    ...
    max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden ' >
        ...
        <motion.img
          ...
          whileInView={{opacity: 1, x:0}}    // When we scroll to this section it will come to its original position
          transition={{duration: 0.6, delay: 0.4}}
         src={assets.banner_car_image} alt="Car_Image" className=' max-h-45 mt-10 '  />
    </motion.div>
  )
}
